#ifndef _ROS_SERVICE_pose_srv_h
#define _ROS_SERVICE_pose_srv_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
namespace pose_service
{

static const char POSE_SRV[] = "pose_service/pose_srv";

  class pose_srvRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return POSE_SRV; };
    virtual const char * getMD5() override { return "2ac278a2a7f2b261fc30a3442c49bde6"; };

  };

  class pose_srvResponse : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return POSE_SRV; };
    virtual const char * getMD5() override { return "9b73b871256d443ebcb390f77d806ff8"; };

  };

  class pose_srv {
    public:
    typedef pose_srvRequest Request;
    typedef pose_srvResponse Response;
  };
